...
local hls = require("themes.integrations.alpha")

highlights = merge_tb(highlights, hls)

-- polish theme specific highlights
local polish_hl = th.get_theme_tb "polish_hl"
...
local colors = th.get_theme_tb "base_30"
