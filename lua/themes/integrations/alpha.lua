...
return {
	...
	TelescopeBorder 		= { fg = colors.white, bg = theme.base00, },
	TelescopePromptBorder 	= { fg = colors.white, bg = theme.base00, },
	TelescopeResultsBorder	= { fg = colors.white, bg = theme.base00, },
	TelescopePreviewBorder	= { fg = colors.white, bg = theme.base00, },
